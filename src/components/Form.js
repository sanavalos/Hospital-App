  ...
  return (
    <div className='md:w-1/2 lg:w-2/5 mx-5'>
      ...
      <form onSubmit={handleSubmit} className='bg-white shadow-md rounded-lg py-10 px-5 mb-10'>
        ...
        <div className='mb-5'>
          <label className='block text-gray-700 uppercase font-bold' htmlFor="pet">Patient's Name</label>
        ...
        <div className='mb-5'>
          <label className='block text-gray-700 uppercase font-bold' htmlFor="realID">Real ID</label>
            <input id='realID' type="number" placeholder="Real ID" className="border-2 w-full  p-2 mt-2 placeholder-gray-400 rounded-md" value={realID} onChange={(e) => setRealID(e.target.value)}/>
        </div>
        ...
        <div className='mb-5'>
          <label className='block text-gray-700 uppercase font-bold' htmlFor="diagnosis">Differential Diagnosis</label>
            <input id='diagnosis' type="text" placeholder="Differential diagnosis" className="border-2 w-full  p-2 mt-2 placeholder-gray-400 rounded-md" value={diagnosis} onChange={(e) => setDiagnosis(e.target.value)}/>
        </div>
